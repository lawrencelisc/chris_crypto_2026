...
# ==========================================
# 1. Filename Parser (Fixed Version)
# ==========================================
def parse_filename(filename):
    ...
    for i, part in enumerate(parts):
        if part in ['BTC', 'ETH', 'SOL']:  # Add your trading symbols
            symbol_idx = i
            resolution_idx = i + 1
            break
...
# ==========================================
# 2. Statistics Calculator (UPDATED - Net Profit)
# ==========================================
def calculate_statistics(df):
    ...
    # Calmar Ratio (using net profit percentage instead of total return)
...
# ==========================================
# 3. Plotting Engine (UPDATED - Net Profit)
# ==========================================
def plot_advanced_analysis(df, params, stats, output_filename):
    ...
    # ========== Chart 3: Equity Curve Comparison (UPDATED) ==========
    ...
    if 'equity_value' in df.columns:
        ...
        # Calculate from returns if equity_value doesn't exist
    ...
    # Plot equity curves (UPDATED labels with Net Profit)
...
# ==========================================
# 4. Main Program (UPDATED - Net Profit)
# ==========================================
def main(csv_file):
    ...
    # Print statistics summary (UPDATED - Net Profit)
    action_counts = stats['action_counts']
    print("\n" + "=" * 60)
    ...
    print(f"Take Profit: {params['take_profit']} | Stop Loss: {params['stop_loss']} | Cycle: {params['cycle']}")
    print("-" * 60)

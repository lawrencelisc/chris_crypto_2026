...
def backtest(para_comb):
    ...
    cross_dir       = para_comb['cross_dir']
    macd_pctl_len   = para_comb['macd_pctl_len']
    macd_pctl       = para_comb['macd_pctl']
    macd_zone       = para_comb['macd_zone']
    ...
    if cross_dir == 'cross_over': df['trade_logic'] = (df['macd_hist'] > 0) & (df['macd_hist-1'] <= 0)
    if cross_dir == 'cross_under': df['trade_logic'] = (df['macd_hist'] < 0) & (df['macd_hist-1'] >= 0)
...
if __name__ == '__main__':
    ...
    para_dict = {
        ...
        'cross_dir': ['cross_over', 'cross_under'],
        'macd_pctl_len': [100, 250],
        'macd_pctl': [1, 5, 10, 15, 20],
        'macd_zone': ['bull', 'bear'],
